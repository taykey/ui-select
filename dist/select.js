 ...
 * Version: 0.8.3 - 2014-11-05T10:52:27.549Z
 * License: MIT
 */
...
(function () {
  ...
  .controller('uiSelectCtrl',
    ...
    ctrl.isActive = function(itemIndex) {
    ...
    ctrl.isSelected = function(item) {
      return (ctrl.selected !== undefined && (!angular.isArray(ctrl.selected) || ctrl.selected.indexOf(item) > -1));
    };

    ctrl.isNotSelected = function(item) {
      return !ctrl.isSelected(item);
    };

    // When the user clicks on an item inside the dropdown
    ctrl.select = function(item, skipFocusser) {
      if(!ctrl.multiple || !ctrl.isSelected(item)) {
        if (item === undefined || !item._uiSelectChoiceDisabled) {
          ...
          var position = ctrl.selected.indexOf(item);
          ctrl.selected.splice(position, 1);
          ctrl.sizeSearchInput();
      }
      if(!ctrl.keepOpen) {
  ...
  .directive('uiSelect',
    ...
    return {
      ...
      link: function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        $select.keepOpen = (angular.isDefined(attrs.keepOpen)) ? (attrs.keepOpen=== '') ? true : (attrs.keepOpen.toLowerCase() === 'true') : false;
...
$templateCache.put("selectize/choices.tpl.html","<div ng-show=\"$select.open\" class=\"ui-select-choices selectize-dropdown single\"><div class=\"ui-select-choices-content selectize-dropdown-content\"><div class=\"ui-select-choices-group optgroup\"><div ng-show=\"$select.isGrouped\" class=\"ui-select-choices-group-label optgroup-header\" ng-bind-html=\"$group.name\"></div><div class=\"ui-select-choices-row\" ng-class=\"{active: $select.isActive($index), disabled: $select.isDisabled(this)}\"><div class=\"option ui-select-choices-row-inner\" data-selectable=\"\"></div></div></div></div></div>");
